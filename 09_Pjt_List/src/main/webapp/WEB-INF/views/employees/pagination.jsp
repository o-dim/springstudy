...
<script>
	$(function(){
		...
		$('.title').on('click', function() {
			location.href = '${contextPath}/employees/pagination.do?column=' + $(this).data('column') + '&order=' + $(this).data('order'); 
		})
	})
</script>
<style>
...
<body>
	<div>
		...
		<a href="${contextPath}/employees/search.form">사원 조회 화면으로 이동하기!!!!!!!</a>
		</MARQUEE>
	</div>
